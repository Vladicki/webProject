...
//     return (
//         <div className="LogIn">
//             {isSignUp ? <SignUpForm handler={handleSignup} setIsSignUp={setIsSignUp} setEmail={setEmail} setUsername={setUsername} setPassword={setPassword}/> 
